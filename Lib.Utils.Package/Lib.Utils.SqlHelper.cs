namespace Lib.Utils.Package
{
    ...
    {
        #region setting configuration parameters
        ...
        #endregion setting configuration parameters
        ...
        /// by a user defined name (probably the actual table name)
        /// </param>
        public async static Task FillDatasetAsync(string connectionString, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames, params SqlParameter[] commandParameters)
        {
            if (string.IsNullOrEmpty(connectionString)) throw new ArgumentNullException("connectionString");
            if (dataSet == null) throw new ArgumentNullException("dataSet");
        ...
        /// </param>
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        public async static Task FillDatasetAsync(string connectionString, string spName, DataSet dataSet, string[] tableNames, params object[] parameterValues)
        {
            if (string.IsNullOrEmpty(connectionString)) throw new ArgumentNullException("connectionString");
            if (dataSet == null) throw new ArgumentNullException("dataSet");
        ...
        /// by a user defined name (probably the actual table name)
        /// </param>
        public static Task FillDatasetAsync(SqlConnection connection, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames)
        {
        ...
        /// </param>
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        public static Task FillDatasetAsync(SqlConnection connection, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames, params SqlParameter[] commandParameters)
        {
        ...
        /// </param>
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        public static Task FillDatasetAsync(SqlConnection connection, string spName, DataSet dataSet, string[] tableNames, params object[] parameterValues)
        {
            if (connection == null) throw new ArgumentNullException("connection");
            if (dataSet == null) throw new ArgumentNullException("dataSet");
            if (string.IsNullOrEmpty(spName)) throw new ArgumentNullException("spName");
        ...
        /// by a user defined name (probably the actual table name)
        /// </param>
        public static Task FillDatasetAsync(SqlTransaction transaction, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames)
        {
        ...
        /// </param>
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        public static Task FillDatasetAsync(SqlTransaction transaction, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames, params SqlParameter[] commandParameters)
        {
        ...
        /// </param>
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        public static Task FillDatasetAsync(SqlTransaction transaction, string spName, DataSet dataSet, string[] tableNames, params object[] parameterValues)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (dataSet == null) throw new ArgumentNullException("dataSet");
        ...
        /// </param>
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
        private async static Task FillDatasetAsync(SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames, params SqlParameter[] commandParameters)
        {
            if (connection == null) throw new ArgumentNullException("connection");
            if (dataSet == null) throw new ArgumentNullException("dataSet");
        ...
        #region 20200424-ExecuteTable

        public static DataTable ExecuteTable(string connectionString, CommandType commandType, string commandText)
        {
            var ds = ExecuteDataset(connectionString, commandType, commandText);
            return ds.HasItem() ? ds.Tables[0] : new DataTable();
        }

        public static DataTable ExecuteTable(string connectionString, string spName, params object[] parameterValues)
        {
            var ds = ExecuteDataset(connectionString, spName, parameterValues);
            return ds.HasItem() ? ds.Tables[0] : new DataTable();
        }
        ...
        #endregion 20200424-ExecuteTable

        #region 20200424-ExecuteTableAsync

        public static async Task<DataTable> ExecuteTableAsync(string connectionString, CommandType commandType, string commandText)
        {
            var ds = await ExecuteDatasetAsync(connectionString, commandType, commandText);
            return ds.HasItem() ? ds.Tables[0] : new DataTable();
        }

        public static async Task<DataTable> ExecuteTableAsync(string connectionString, string spName, params object[] parameterValues)
        {
            var ds = await ExecuteDatasetAsync(connectionString, spName, parameterValues);
            return ds.HasItem() ? ds.Tables[0] : new DataTable();
        }

        public static async Task<DataTable> ExecuteTableAsync(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            var ds = await ExecuteDatasetAsync(connectionString, commandType, commandText, commandParameters);
            return ds.HasItem() ? ds.Tables[0] : new DataTable();
        }

        #endregion 20200424-ExecuteTableAsync

        #region 20200515-ExecuteList

        public static List<T> ExecuteList<T>(string connectionString, CommandType commandType, string commandText) where T : new()
        {
            var dt = ExecuteTable(connectionString, commandType, commandText);
            return dt.HasRow() ? dt.ToList<T>() : new List<T>();
        }

        public static List<T> ExecuteList<T>(string connectionString, string spName, params object[] parameterValues) where T : new()
        {
            var dt = ExecuteTable(connectionString, spName, parameterValues);
            return dt.HasRow() ? dt.ToList<T>() : new List<T>();
        }

        public static List<T> ExecuteList<T>(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters) where T : new()
        {
            var dt = ExecuteTable(connectionString, commandType, commandText, commandParameters);
            return dt.HasRow() ? dt.ToList<T>() : new List<T>();
        }

        #endregion

        #region 20200515-ExecuteListAsync

        public static async Task<List<T>> ExecuteListAsync<T>(string connectionString, CommandType commandType, string commandText) where T : new()
        {
            var dt = await ExecuteTableAsync(connectionString, commandType, commandText);
            return dt.HasRow() ? dt.ToList<T>() : new List<T>();
        }

        public static async Task<List<T>> ExecuteListAsync<T>(string connectionString, string spName, params object[] parameterValues) where T : new()
        {
            var dt = await ExecuteTableAsync(connectionString, spName, parameterValues);
            return dt.HasRow() ? dt.ToList<T>() : new List<T>();
        }

        public static async Task<List<T>> ExecuteListAsync<T>(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters) where T : new()
        {
            var dt = await ExecuteTableAsync(connectionString, commandType, commandText, commandParameters);
            return dt.HasRow() ? dt.ToList<T>() : new List<T>();
        }

        #endregion

        #region 20200515-ExecuteFirstItem

        public static T ExecuteFirstItem<T>(string connectionString, CommandType commandType, string commandText) where T : new()
        {
            var ls = ExecuteList<T>(connectionString, commandType, commandText);
            return ls.HasItem() ? ls[0] : new T();
        }

        public static T ExecuteFirstItem<T>(string connectionString, string spName, params object[] parameterValues) where T : new()
        {
            var ls = ExecuteList<T>(connectionString, spName, parameterValues);
            return ls.HasItem() ? ls[0] : new T();
        }

        public static T ExecuteFirstItem<T>(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters) where T : new()
        {
            var ls = ExecuteList<T>(connectionString, commandType, commandText, commandParameters);
            return ls.HasItem() ? ls[0] : new T();
        }

        #endregion

        #region 20200515-ExecuteFirstItemAsync

        public static async Task<T> ExecuteFirstItemAsync<T>(string connectionString, CommandType commandType, string commandText) where T : new()
        {
            var ls = await ExecuteListAsync<T>(connectionString, commandType, commandText);
            return ls.HasItem() ? ls[0] : new T();
        }

        public static async Task<T> ExecuteFirstItemAsync<T>(string connectionString, string spName, params object[] parameterValues) where T : new()
        {
            var ls = await ExecuteListAsync<T>(connectionString, spName, parameterValues);
            return ls.HasItem() ? ls[0] : new T();
        }

        public static async Task<T> ExecuteFirstItemAsync<T>(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters) where T : new()
        {
            var ls = await ExecuteListAsync<T>(connectionString, commandType, commandText, commandParameters);
            return ls.HasItem() ? ls[0] : new T();
        }

        #endregion

        #region 20200515-ExecuteLastItem

        public static T ExecuteLastItem<T>(string connectionString, CommandType commandType, string commandText) where T : new()
        {
            var ls = ExecuteList<T>(connectionString, commandType, commandText);
            return ls.HasItem() ? ls[ls.Count - 1] : new T();
        }

        public static T ExecuteLastItem<T>(string connectionString, string spName, params object[] parameterValues) where T : new()
        {
            var ls = ExecuteList<T>(connectionString, spName, parameterValues);
            return ls.HasItem() ? ls[ls.Count - 1] : new T();
        }

        public static T ExecuteLastItem<T>(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters) where T : new()
        {
            var ls = ExecuteList<T>(connectionString, commandType, commandText, commandParameters);
            return ls.HasItem() ? ls[ls.Count - 1] : new T();
        }
        ...
        #region 20200515-ExecuteLastItemAsync

        public static async Task<T> ExecuteLastItemAsync<T>(string connectionString, CommandType commandType, string commandText) where T : new()
        {
            var ls = await ExecuteListAsync<T>(connectionString, commandType, commandText);
            return ls.HasItem() ? ls[ls.Count - 1] : new T();
        }

        public static async Task<T> ExecuteLastItemAsync<T>(string connectionString, string spName, params object[] parameterValues) where T : new()
        {
            var ls = await ExecuteListAsync<T>(connectionString, spName, parameterValues);
            return ls.HasItem() ? ls[ls.Count - 1] : new T();
        }

        public static async Task<T> ExecuteLastItemAsync<T>(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters) where T : new()
        {
            var ls = await ExecuteListAsync<T>(connectionString, commandType, commandText, commandParameters);
            return ls.HasItem() ? ls[ls.Count - 1] : new T();
        }
    ...
    /// <summary>
    /// BulkHelper provides functions to execute quickly bulk copying large data into table.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public sealed class BulkHelper<T>
    {
        #region private, public properties

        private List<T> InternalStore { get; set; }

        private string DestinationTable { get; set; }

        private string ConnectionString { get; set; }

        private int CommitBatchSize { get; set; }

        private int BulkCopyTimeout { get; set; }

        private int RowPosOffset { get; set; }

        private bool ValidArgs => InternalStore.NotNull() && DestinationTable.NotNull() && ConnectionString.NotNull() && CommitBatchSize > 0 && BulkCopyTimeout > 0;

        private string InnerException { get; set; }

        public string CommitException { get; private set; }

        #endregion private, public properties

        #region private, public methods, and constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="T:Lib.Utils.Package.BulkHelper`1"/>,
        /// which uses <c>SetArgument</c> function to setting up mandatory arguments.
        /// <code>Mandatory:</code>
        /// <code>1. <see cref="T:System.Collections.Generic.List`1"/> InternalStore</code>
        /// <code>2. <see cref="string"/> DestinationTable</code>
        /// <code>3. <see cref="string"/> ConnectionString</code>
        /// <code>Optional:</code>
        /// <code>4. <see cref="int"/> CommitBatchSize</code>
        /// <code>5. <see cref="int"/> BulkCopyTimeout</code>
        /// <code>6. <see cref="int"/> RowPosOffset</code>
        /// </summary>
        public BulkHelper()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Lib.Utils.Package.BulkHelper`1"/> with input aguments.
        /// </summary>
        ...
        /// <param name="RowPosOffset"></param>
        public BulkHelper(List<T> InternalStore, string DestinationTable, string ConnectionString, int CommitBatchSize = 1000, int BulkCopyTimeout = 120, int RowPosOffset = 0)
        {
            ...
            this.RowPosOffset = RowPosOffset;
        }

        /// <summary>
        /// Assign value to input args.
        /// </summary>
        /// <param name="ArgumentType"></param>
        /// <param name="ArgumentValue"></param>
        public void Assigning(Sets ArgumentType, dynamic ArgumentValue)
        {
            try
            {
                switch (ArgumentType)
                {
                    case Sets.InternalStore:
                        InternalStore = (List<T>)ArgumentValue;
                        break;

                    case Sets.DestinationTable:
                        DestinationTable = (string)ArgumentValue;
                        break;

                    case Sets.ConnectionString:
                        ConnectionString = (string)ArgumentValue;
                        break;

                    case Sets.CommitBatchSize:
                        CommitBatchSize = (int)ArgumentValue;
                        break;

                    case Sets.BulkCopyTimeout:
                        BulkCopyTimeout = (int)ArgumentValue;
                        break;

                    case Sets.RowPosOffset:
                        RowPosOffset = (int)ArgumentValue;
                        break;
                }
            }
            catch
        ...
        public bool BulkCommit()
        {
            try
            {
                if (ValidArgs)
                {
                    ...
                    {
                        // Initializes and open connection
                        SqlConnection connection = new SqlConnection(ConnectionString);
                        connection.Open();

                        // Calculating the number of pages
                        int numOfPages = (InternalStore.Count / CommitBatchSize) + (InternalStore.Count % CommitBatchSize == 0 ? 0 : 1);

                        for (int index = 1; index <= numOfPages; index++)
                        {
                            int skipRows = (index - 1) * CommitBatchSize;

                            IEnumerable<T> page = InternalStore.Skip(skipRows).Take(CommitBatchSize);

                            DataTable data = page.ToDataTable();

                            int numOfRows = page.Count();

                            if (BulkInsert(data, connection))
                            {
                                data.Clear();
                            }
                            else
                            {
                                // Make exception
                                int fromRow = skipRows + RowPosOffset + 1;
                                int toRow = fromRow - 1 + (numOfRows < CommitBatchSize ? numOfRows : CommitBatchSize);
                                CommitException = string.Format("[Commit()][{0}-{1}] {2}", fromRow, toRow, InnerException);
                ...
                CommitException = "[Commit()] Invalid arguments.";
            }
            catch (Exception ex)
            {
                CommitException = "[Commit()] " + ex.Message;
            }
        ...
        /// <summary>
        /// The asynchronous version of <see cref="BulkCommit"/>, which commits transaction.
        /// </summary>
        /// <returns></returns>
        public async Task<bool> BulkCommitAsync()
        {
            try
            {
                if (ValidArgs)
                {
                    if (InternalStore.Count > 0)
                    {
                        ...
                        for (int index = 1; index <= numOfPages; index++)
                        {
                            ...
                            if (await BulkInsertAsync(data, connection))
                            {
                                data.Clear();
                            }
                            else
        ...
        /// </summary>
        /// <param name="obj">The supplied DataTable.</param>
        /// <param name="connection">The connection object.</param>
        /// <returns></returns>
        private bool BulkInsert(DataTable obj, SqlConnection connection)
        {
            try
            {
        ...
        /// <summary>
        /// The asynchronous version of <see cref="BulkInsert"/>, which copies all rows in the supplied DataTable to a destination table.
        /// </summary>
        /// <param name="obj">The supplied DataTable.</param>
        /// <param name="connection">The connection object.</param>
        /// <returns></returns>
        private async Task<bool> BulkInsertAsync(DataTable obj, SqlConnection connection)
        {
            try
            {
                // Make sure connection is open
                ...
                // The asynchronous version of WriteToServer(DataTable),
        ...
        #endregion private, public methods, and constructors
    }

    /// <summary>
    /// BulkHelper arguments.
    /// </summary>
    public enum Sets
    {
        /// <summary>
        /// Mandatory argument, data type is <see cref="T:System.Collections.Generic.List`1"/>
        /// </summary>
        InternalStore,

        /// <summary>
        /// Mandatory argument, data type is <see cref="string"/>
        /// </summary>
        DestinationTable,
        ...
        /// <summary>
        /// Optional argument, data type is <see cref="int"/>
        /// </summary>
        CommitBatchSize,
        ...
        /// <summary>
        /// Optional argument, data type is <seealso cref="int"/>
        /// </summary>
        RowPosOffset
    }
}